...
pacman -S --noconfirm audacity cdrtools chromium devede dnsmasq dvd+rw-tools eza fastfetch gimp gvfs-dnssd handbrake hplip htop inetutils inkscape jre-openjdk k3b kid3 kleopatra lib32-gcc-libs lib32-glibc libaacs libdvdcss libgpod libreoffice-fresh mkvtoolnix-gui musescore nextcloud-client obs-studio plymouth psensor qemu-full qt6-wayland reflector rhythmbox rocm-opencl-runtime rpi-imager steam texlive-latex texstudio timeshift tk transmission-gtk ttf-liberation ttf-roboto udftools ufw v4l2loopback-dkms virt-manager virtualbox vlc wireguard-tools yt-dlp
