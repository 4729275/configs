...
paru -S mullvad-vpn-bin zoom

# Install Flatpak packages
echo "Installing Flatpak packages - manual confirmation required:"
flatpak install -y flathub com.github.tchx84.Flatseal com.google.EarthPro org.io.github.realmazharhussain.GdmSettings jellyfin.JellyfinDesktop io.gitlab.news_flash.NewsFlash com.nextcloud.desktopclient.nextcloud org.onlyoffice.desktopeditors
