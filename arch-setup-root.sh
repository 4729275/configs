...
pacman -S --noconfirm audacity audio-convert exa firefox gimp hplip htop inkscape kid3 kleopatra libdvdcss libreoffice-still libxcrypt-compat man-db musescore neofetch ntfs-3g obs-studio psensor qemu-base qt6-wayland rhythmbox steam virt-manager vlc wireguard-tools yt-dlp
