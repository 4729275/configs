...
pacman -S --noconfirm audacity audio-convert brasero dnsmasq eza firefox gimp gvfs-dnssd handbrake hplip htop inkscape kid3 kleopatra libaacs libdvdcss libreoffice-fresh libxcrypt-compat man-db musescore nextcloud-client ntfs-3g obs-studio psensor pulseaudio-alsa qemu-full qt6-wayland reflector rhythmbox seahorse steam texlive-latex texstudio tigervnc timeshift transmission-gtk ttf-roboto ufw v4l2loopback-dkms virt-manager virtualbox vlc wireguard-tools yt-dlp
