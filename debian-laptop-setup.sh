...
apt-get install audacity eza fastfetch flatpak fonts-noto-cjk fonts-roboto gnome-software-plugin-flatpak gnome-themes-extra htop nextcloud-desktop plymouth-themes psensor python3-tk rhythmbox systemd-zram-generator texstudio timeshift tlp tlp-rdw ufw v4l2loopback-dkms vim virt-manager wireguard yt-dlp -y
flatpak remote-add --if-not-exists flathub https://dl.flathub.org/repo/flathub.flatpakrepo
flatpak install flathub com.github.tchx84.Flatseal com.google.EarthPro org.gimp.GIMP fr.handbrake.ghb org.inkscape.Inkscape org.kde.kid3 org.bunkus.mkvtoolnix-gui com.obsproject.Studio org.onlyoffice.desktopeditors org.videolan.VLC com.github.xournalpp.xournalpp -y
