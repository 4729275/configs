...
dnf install audacity cabextract eza gimp gnome-console gnome-themes-extra gnome-tweaks google-roboto-fonts htop inkscape kleopatra nextcloud-client seahorse snapshot texlive-latex texstudio tilem timeshift tlp tlp-rdw vim-enhanced virt-manager vlc wireguard-tools xorg-x11-font-utils xsensors -y
