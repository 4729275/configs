...
pacman -Sy --noconfirm akregator audacity cdrtools devede dnsmasq dvd+rw-tools eza fastfetch firefox gimp handbrake hplip htop inetutils inkscape jre-openjdk k3b kid3 kleopatra ktorrent lib32-gcc-libs lib32-glibc libaacs libdvdcss libreoffice-fresh mkvtoolnix-gui musescore nextcloud-client obs-studio psensor qemu-full reflector rocm-opencl-runtime rpi-imager steam strawberry texlive-latex texstudio timeshift tk ttf-liberation ttf-roboto udftools ufw v4l2loopback-dkms virt-manager virtualbox vulkan-radeon wireguard-tools yt-dlp
