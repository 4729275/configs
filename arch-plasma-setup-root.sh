...
pacman -Sy --noconfirm akregator audacity cdrdao cdrtools devede dnsmasq dvd+rw-tools eza fastfetch firefox gimp handbrake hplip htop inetutils inkscape jre-openjdk k3b kid3 kleopatra ktorrent lib32-gcc-libs lib32-glibc libaacs libdvdcss libgpod libreoffice-fresh mkvtoolnix-gui musescore nextcloud-client obs-studio psensor qemu-full reflector rhythmbox rocm-opencl-runtime rpi-imager steam texlive-latex texstudio timeshift tk ttf-liberation ttf-roboto udftools ufw v4l2loopback-dkms virt-manager virtualbox virtualbox-guest-iso virtualbox-host-modules-arch vulkan-radeon wireguard-tools yt-dlp
